...
static const char* FILE_UP   = "CMT_project/data/scenario_P_up.csv";   // P_up (+1%/an)
static const char* FILE_DOWN = "CMT_project/data/scenario_P_down.csv";  // P_down (-1%/an)
static const char* FILE_CST  = "CMT_project/data/scenario_P_constant.csv";   // P_cst (constant)
static const char* FILE_OUT  = "CMT_project/Results/ndvi_futur_combined.csv";             // sortie fusionnée
