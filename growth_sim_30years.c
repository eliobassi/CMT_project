...
// Function to update biomass based on the current biomass (B), precipitation (P),
// initial growth rate (r0), precipitation sensitivity (alpha), and carrying capacity (K)
...
// Function to simulate growth over time for a given region, based on a scenario CSV file
// and output the results to another CSV file.
void simulate_growth(char *scenario_csv, char *output_csv) {
    ...
    while (fgets(line, MAXLINE, fp)) {
        ...
        // New region → simulate the previous one
